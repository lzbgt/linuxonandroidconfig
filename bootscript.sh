###########################################
# Linux boot script V8 for Android pre 4.3#
...
###########################################
$bbox mount -o bind,rw,noatime,exec /dev $mnt/dev
...
mount -o remount,rw,noatime,exec /storage/sdcard0
...
if [ -d /sdcard1 ]; then
	...
	$bbox mount -o bind /sdcard1  $mnt/external_sd
fi
